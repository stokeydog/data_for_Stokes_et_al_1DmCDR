...
function run_CN_1D_parallel_no_buffering(diffusivity::Float64)
    # Load configuration
    ...
    ALK_up, DIC_up, pH_up, pCO2_up, ΔpCO2_up, F_up, tiF_up, rho_matrix_up, kg_m_per_s = PoseidonMRV.CrankNicholsonNoBuffering1D.timestep!(
    ...
    ALK_p, DIC_p, pH_p, pCO2_p, ΔpCO2_p, F_p, tiF_p, rho_matrix_p, kg_m_per_s = PoseidonMRV.CrankNicholsonNoBuffering1D.timestep!(
