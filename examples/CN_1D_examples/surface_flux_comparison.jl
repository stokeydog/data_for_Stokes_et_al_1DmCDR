...
color_palette = Plots.palette(:viridis, 3) 
...
p = plot( data["output"]["TI"] ./ 86400, (flux_surf); 
        size = (1200,500),
        label = "surface flux, high mixing",
        xlabel = "Time (days)", 
...
plot!(p, data["output"]["TI"] ./ 86400, (flux_surf);  
        label = "surface flux, intermediate mixing",
        linewidth = 3,
...
plot!(p, data["output"]["TI"] ./ 86400, (flux_surf); 
        label = "surface flux, weak mixing",
        linewidth = 3,
